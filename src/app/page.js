    ...
    <Box sx={{ flexGrow: 1 }}>
      ...
      {showFirstPage && (
        <Box component="section" sx={{ p: 2, border: "1px dashed grey" }}>
          This is a very basic application. This has a bar across the top and this box! How this apps work is by creating two boxes. They are hidden in the background of the page. It is only when a user clicks one of the buttons, we change the "state" from hidden (false) to show (true)
        </Box>
      )}
      {showLogin && (
        <Box component="section" sx={{ p: 2, border: "1px dashed grey" }}>
